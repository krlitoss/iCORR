 ...
 * @author Skarton
 */
public class busca_usocomprobante extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_usocomprobante(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM uso_comprobantes";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_usocomprobantes"),rs0.getString("clave_usocomprobante"),rs0.getString("usocomprobante")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_usocomprobante.class);
