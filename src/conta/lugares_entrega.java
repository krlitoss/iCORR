 ...
 * @author IVONNE
 */
public class lugares_entrega extends javax.swing.JInternalFrame {
    ...
    public lugares_entrega(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Lugares de Entrega");
    }
    public void ajusteTabladatos() {
        ...
        Tabladatos.getColumnModel().getColumn(4).setPreferredWidth(160);
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT lugares_entregas.*,clientes.nombre FROM lugares_entregas LEFT JOIN clientes ON lugares_entregas.id_clientes=clientes.id_clientes ORDER BY id_lugarentrega";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_lugarentrega"),rs0.getString("nombre"),rs0.getString("calle")+" "+rs0.getString("numeroext")+" Col. "+rs0.getString("colonia"),rs0.getString("municipio"),rs0.getString("estado"),rs0.getString("contacto"),rs0.getString("telefono1")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_lugares_entrega = new datos_lugares_entrega(null,true,conn,clavemodifica,valor_privilegio);
                datos_lugares_entrega.setLocationRelativeTo(this);
                datos_lugares_entrega.setVisible(true);
                limpiatabla();
                datos_lugares_entrega=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(lugares_entrega.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Nombre del Cliente", "Direccion", "Municipio", "Estado", "Contacto", "Telefono"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_lugares_entrega = new datos_lugares_entrega(null,true,conn,"",valor_privilegio);
        datos_lugares_entrega.setLocationRelativeTo(this);
        datos_lugares_entrega.setVisible(true);
        limpiatabla();
        datos_lugares_entrega=null;
    ...
    */
    ...
    private JDialog datos_lugares_entrega;
}
