...
public class conceptos extends javax.swing.JInternalFrame {
    ...
    public conceptos(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Conceptos Movimientos bancarios");
    }
    public void ajusteTabladatos() {
        Tabladatos.getColumnModel().getColumn(0).setPreferredWidth(70);
        Tabladatos.getColumnModel().getColumn(1).setPreferredWidth(330);
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM movconceptos ORDER BY id_movconcepto";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_movconcepto"),rs0.getString("descripcion"),rs0.getString("tipo")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_conceptos = new datos_conceptos(null,true,conn,clavemodifica,valor_privilegio);
                datos_conceptos.setLocationRelativeTo(this);
                datos_conceptos.setVisible(true);
                limpiatabla();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(conceptos.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_conceptos = new datos_conceptos(null,true,conn,"",valor_privilegio);
        datos_conceptos.setLocationRelativeTo(this);
        datos_conceptos.setVisible(true);
        limpiatabla();
        datos_conceptos=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/conceptos.jasper"));
    ...
    */
    ...
    private JDialog datos_conceptos;
}
