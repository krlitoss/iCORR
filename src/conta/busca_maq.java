 ...
 * @author ANGEL
 */
public class busca_maq extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_maq(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    busca_maq(Object object, boolean b) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_maq.class);
