 ...
 * @author ANGEL
 */
public class busca_transportistas extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_transportistas(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM transportistas";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("clave_transportista"),rs0.getString("nombre"),rs0.getString("tipounidad"),rs0.getString("placas")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_transportistas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Descripción", "Tipo Unidad", "Placas"
            }
        ) {
