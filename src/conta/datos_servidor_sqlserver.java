 ...
 * @author IVONNE
 */
public class datos_servidor_sqlserver extends javax.swing.JDialog {
    private Properties conf;

    /** Creates new form datos_servidor */
    public datos_servidor_sqlserver(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        configuracion();
    ...
    public void configuracion(){
        try{
            ...
            driver.setSelectedItem(conf.getProperty("sql_Drivers"));
            servidor.setSelectedItem(conf.getProperty("sql_Servidor"));
            puerto.setText(conf.getProperty("sql_Puerto"));
            bd.setText(conf.getProperty("sql_BD"));
            usuario.setText(conf.getProperty("sql_UsuarioBD"));
            clave.setText(conexion.decodificarCadena(conf.getProperty("sql_PassBD")));
            instancia.setText(conf.getProperty("sql_Instancia"));
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_servidor_sqlserver.class);
        ...
        driver.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "com.microsoft.sqlserver.jdbc.SQLServerDriver" }));
        ...
        instancia.setText(resourceMap.getString("instancia.text")); // NOI18N
        instancia.setName("instancia"); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(instancia, javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(servidor, javax.swing.GroupLayout.Alignment.LEADING, 0, 108, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
    ...
    if(serv.equals("") || bd.getText().equals("") || usuario.getText().equals("") || contra.equals(""))
    {
        JOptionPane.showMessageDialog(this, "VERIFICA HAY CAMPOS VACIOS", "E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
    }else{
        /**generar archivo*/
        conexion.escribir("sql_Drivers", (String)driver.getSelectedItem());
        conexion.escribir("sql_Servidor", (String)servidor.getSelectedItem());
        conexion.escribir("sql_Puerto", puerto.getText());
        conexion.escribir("sql_BD", bd.getText());
        conexion.escribir("sql_UsuarioBD", usuario.getText());
        conexion.escribir("sql_PassBD", contra);
        conexion.escribir("sql_Instancia", instancia.getText());
        salir();
    }
