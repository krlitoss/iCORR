 ...
 * busca_bancos.java
 *
 * Created on 26/10/2017, 05:27:05 PM
 */
 ...
 * @author SKARTON
 */
public class busca_bancos extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    DefaultTableModel modelot1=null;
    String clavebusca="0";

    /** Creates new form formas_pagos */
    public busca_bancos(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM bancos ORDER BY id_banco";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("clave_banco"),rs0.getString("descripcion")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_bancos.class);
