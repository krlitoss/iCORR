 ...
 * @author IVONNE
 */
public class transportistas extends javax.swing.JInternalFrame {
    ...
    public transportistas(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Transportistas");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM transportistas WHERE estatus<>'Can';";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("clave_transportista"),rs0.getString("empresa"),rs0.getString("nombre"),rs0.getString("tipounidad"),rs0.getString("placas"),rs0.getInt("capacidad"),rs0.getString("clave_unidad_medida")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_transportistas = new datos_transportistas(null,true,conn,clavemodifica,valor_privilegio);
                datos_transportistas.setLocationRelativeTo(this);
                datos_transportistas.setVisible(true);
                limpiatabla();
                datos_transportistas=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(transportistas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Empresa", "Nombre", "Tipo Unidad", "Placas", "Capacidad", "UM"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_transportistas = new datos_transportistas(null,true,conn,"",valor_privilegio);
        datos_transportistas.setLocationRelativeTo(this);
        datos_transportistas.setVisible(true);
        limpiatabla();
        datos_transportistas=null;
    ...
    */
    ...
    private JDialog datos_transportistas;
}
