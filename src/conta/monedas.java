...
public class monedas extends javax.swing.JInternalFrame {
    ...
    public monedas(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Monedas");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM monedas ORDER BY id_moneda";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_moneda"),rs0.getString("descripcion"),rs0.getString("terminacion"),rs0.getDouble("valor")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_monedas = new datos_monedas(null,true,conn,clavemodifica,valor_privilegio);
                datos_monedas.setLocationRelativeTo(this);
                datos_monedas.setVisible(true);
                limpiatabla();
                datos_monedas=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(monedas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Descripcion", "Terminacion", "Tipo Cambio"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_monedas = new datos_monedas(null,true,conn,"",valor_privilegio);
        datos_monedas.setLocationRelativeTo(this);
        datos_monedas.setVisible(true);
        limpiatabla();
        datos_monedas=null;
