 ...
 * @author ANGEL
 */
public class busca_no_almacen_rollos extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_no_almacen_rollos(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("clave"),rs0.getString("descripcion")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_no_almacen_rollos.class);
