 ...
 * @author ANGEL
 */
public class busca_fechasproveedor extends javax.swing.JDialog {
    ...
    public busca_fechasproveedor(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
        connj=conn;
        conf=conexion.archivoInicial();
        configuracion();
        if(clavemodifica.equals("Consulta")){ /** si la peticion es de consulta deshabilita resumen o detalle*/
    ...
    public String getProveedor() {
        return (String)proveedor.getSelectedItem();
    }
    public String getID() {
        return id_pro.getText();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_fechasproveedor.class);
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Resumen", "Detalle" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tipo, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        proveedor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos", "Buscar" }));
        ...
        id_pro.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        id_pro.setText(resourceMap.getString("id_pro.text")); // NOI18N
        id_pro.setFocusable(false);
        id_pro.setName("id_pro"); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(proveedor, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, 116, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(id_pro, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(id_pro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        try{
            if(fechaini.getDate().after(fechafin.getDate()) || fechaini.getDate()==null || fechafin.getDate()==null){
                ...
                String seleccionaproveedor=(String)proveedor.getSelectedItem();
                if(seleccionaproveedor.equals("Buscar")&&id_pro.getText().equals("0")){
                    JOptionPane.showMessageDialog(this, "TIENES QUE SELECCIONAR UN PROVEEDOR O CAMBIA A TODOS", "E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
                }else{
                    configuracionSalida();
                    estado="aceptar";
                    salir();
    ...
    private void proveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proveedorActionPerformed
        // TODO add your handling code here:
        String bproveedor=(String)proveedor.getSelectedItem();
        if(bproveedor.equals("Buscar")){
            ...
            id_pro.setText(busca_proveedores.getText());//obtiene el valor seleccionado
