 ...
 * @author ANGEL
 */
public class busca_agentes extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_agentes(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_agente"),rs0.getString("nombre"),rs0.getDouble("comision")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_agentes.class);
