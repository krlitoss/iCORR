 ...
 * @author IVONNE
 */
public class datos_proveedores2 extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_proveedores2(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT * FROM proveedores2 WHERE id_proveedor2='"+clavemodifica+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    id.setText(rs0.getString("id_proveedor2"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_proveedores2.class);
