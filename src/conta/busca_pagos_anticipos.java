 ...
 * @author ANGEL
 */
public class busca_pagos_anticipos extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_pagos_anticipos(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_pagos_anticipos"),fechamediana.format(rs0.getDate("fechapago")),rs0.getString("nombre"),(rs0.getDouble("importe")-rs0.getDouble("importe_pagos")),rs0.getString("documento"),rs0.getString("motivo")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_pagos_anticipos.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Cliente", "Saldo", "Documento", "Motivo"
            }
        ) {
