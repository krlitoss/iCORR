 ...
 * @author IVONNE
 */
public final class CFDFactory_nc32 {
    ...
    private static Conceptos createConceptos(ObjectFactory of, Connection conec, String documento) {
        ...
        rs0 = null;
        try {
            String senSQL = "SELECT notas_credito_detalle.id_notas_credito_detalle, notas_credito_detalle.nota_credito_serie, notas_credito_detalle.fecha, notas_credito_detalle.estatus, "
            +" notas_credito_detalle.serie, notas_credito_detalle.factura_serie, "
            +" (CASE WHEN notas_credito_detalle.um='millar' OR notas_credito_detalle.um='MILLAR' THEN (notas_credito_detalle.cantidad/1000) ELSE notas_credito_detalle.cantidad END ) AS cantidad,"
            +" (CASE WHEN notas_credito_detalle.um='millar' OR notas_credito_detalle.um='MILLAR' THEN (notas_credito_detalle.preciounitario*1000) ELSE notas_credito_detalle.preciounitario END ) AS preciounitario,"
            +" notas_credito_detalle.descripcion, notas_credito_detalle.um, "
            +" notas_credito_detalle.importe, notas_credito_detalle.subtotal, notas_credito_detalle.remision, notas_credito_detalle.nota_credito FROM notas_credito_detalle WHERE nota_credito_serie='" + documento + "';";
            rs0 = conexion.consulta(senSQL, conec);
            while (rs0.next()) {
