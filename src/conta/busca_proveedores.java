 ...
 * @author ANGEL
 */
public class busca_proveedores extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_proveedores(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_proveedor"),rs0.getString("nombre"),rs0.getInt("dias")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_proveedores.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre del Proveedor", "Dias de Crédito"
            }
        ) {
