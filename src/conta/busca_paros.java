 ...
 * @author ANGEL
 */
public class busca_paros extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_paros(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM paros WHERE activo='Si' ORDER BY id_paro";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_paros.class);
