 ...
 * @author IVONNE
 */
public class datos_areas_empresa extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    String valor_privilegio="1";

    /** Creates new form datos_usuarios */
    public datos_areas_empresa(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            try{
                String senSQL="SELECT * FROM areas_empresa WHERE area_empresa='"+clavemodifica+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    id.setText(rs0.getString("area_empresa"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_areas_empresa.class);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(descripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 277, Short.MAX_VALUE)
                                    .addComponent(id, javax.swing.GroupLayout.DEFAULT_SIZE, 277, Short.MAX_VALUE))))))
                .addContainerGap())
        );
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(id.getText().equals("") || descripcion.getText().equals("")){
            ...
            String senSQL="UPDATE areas_empresa set descripcion='"+descripcion.getText()+"' WHERE area_empresa='"+id.getText()+"'";
            if(id.isFocusable()){
                senSQL="INSERT INTO areas_empresa (area_empresa,descripcion) VALUES('"+id.getText()+"','"+descripcion.getText()+"');";
            }
    ...
    private void idFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_idFocusLost
        ...
        if(id.getText().equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT * FROM areas_empresa WHERE area_empresa='"+id.getText()+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    JOptionPane.showMessageDialog(this,"LA CLAVE DE AREA YA EXISTE","E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
                    id.setText("");
                    id.requestFocus();
                }
                if(rs0!=null) {
