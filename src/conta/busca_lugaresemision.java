 ...
 * @author ANGEL
 */
public class busca_lugaresemision extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_lugaresemision(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM lugaresemision";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_lugaremision"),rs0.getString("municipio"),rs0.getString("estado"),rs0.getString("pais")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_lugaresemision.class);
