 ...
 * @author IVONNE
 */
public class datos_grabados extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_grabados(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT grabados.*,articulos.articulo,clientes.nombre FROM grabados LEFT JOIN (articulos LEFT JOIN clientes ON articulos.id_clientes=clientes.id_clientes) ON grabados.clavearticulo=articulos.clavearticulo WHERE grabados.clave_grabado='"+clavemodifica+"';";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    clave.setText(rs0.getString("clave_grabado"));
                    obsoleto.setSelectedItem(rs0.getString("obsoleto"));
                    fecha.setDate(rs0.getDate("fecha"));
                    cmlineales.setText(rs0.getString("cm"));
                    preciocm.setText(rs0.getString("costo_cm"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_grabados.class);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(cmlineales, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(preciocm, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(15, 15, 15)
                                .addComponent(jLabel14, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(obsoleto, 0, 52, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(fecha.getDate()==null||clavearticulo.getText().equals("")){
            ...
            if(clavemodificaf.equals("")){
                String senSQL="INSERT INTO grabados(clave_grabado, fecha,cm, costo_cm, clavearticulo,observaciones, obsoleto) VALUES ('"+clave.getText()+"', '"+fechainsertarhora.format(fecha.getDate())+"', '"+cmlineales.getText()+"', '"+preciocm.getText()+"', '"+clavearticulo.getText()+"', '"+observaciones.getText()+"', 'No');";
                conexion.modifica_p(senSQL,connj,valor_privilegio);
            }else{
                String senSQL="UPDATE grabados SET fecha='"+fechainsertarhora.format(fecha.getDate())+"', cm='"+cmlineales.getText()+"', costo_cm='"+preciocm.getText()+"', observaciones='"+observaciones.getText()+"', obsoleto='"+(String)obsoleto.getSelectedItem()+"' WHERE clave_grabado='"+clave.getText()+"';";
                conexion.modificaupdate_p(senSQL,connj,valor_privilegio);
                String obs=""+obsoleto.getSelectedItem();
                if(obs.equals("Si")){
                    senSQL="UPDATE grabados SET fechaobsoleto='"+fechainsertarhora.format(new Date())+"' WHERE clave_grabado='"+clave.getText()+"';";
    ...
    private void claveFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_claveFocusLost
        ...
        if(clave.getText().equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT * FROM grabados WHERE (clave_grabado='"+clave.getText()+"')";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    JOptionPane.showMessageDialog(this,"LA CLAVE DE GRABADO YA EXISTE","E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
                    clave.setText("");
                    clave.requestFocus();
                }
                if(rs0!=null) {
