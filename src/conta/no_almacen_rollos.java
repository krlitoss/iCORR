 ...
 * @author IVONNE
 */
public class no_almacen_rollos extends javax.swing.JInternalFrame {
    ...
    public no_almacen_rollos(Connection connt) {
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_no_almacen"),rs0.getString("clave"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_no_almacen_rollos = new datos_no_almacen_rollos(null,true,conn,clavemodifica,valor_privilegio);
                datos_no_almacen_rollos.setLocationRelativeTo(this);
                datos_no_almacen_rollos.setVisible(true);
                limpiatabla();
                datos_no_almacen_rollos=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(no_almacen_rollos.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_no_almacen_rollos = new datos_no_almacen_rollos(null,true,conn,"",valor_privilegio);
        datos_no_almacen_rollos.setLocationRelativeTo(this);
        datos_no_almacen_rollos.setVisible(true);
        limpiatabla();
        datos_no_almacen_rollos=null;
    ...
    */
    ...
    private JDialog datos_no_almacen_rollos;
}
