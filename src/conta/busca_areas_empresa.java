 ...
 * @author ANGEL
 */
public class busca_areas_empresa extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_areas_empresa(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM areas_empresa;";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_areas_empresa.class);
