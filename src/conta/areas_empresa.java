 ...
 * @author IVONNE
 */
public class areas_empresa extends javax.swing.JInternalFrame {
    ...
    public areas_empresa(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Areas de la Empresa");
    }
    public void ajusteTabladatos() {
        Tabladatos.getColumnModel().getColumn(0).setPreferredWidth(150);
        Tabladatos.getColumnModel().getColumn(1).setPreferredWidth(220);
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM areas_empresa ORDER BY area_empresa";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("area_empresa"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_areas_empresa = new datos_areas_empresa(null,true,conn,clavemodifica,valor_privilegio);
                datos_areas_empresa.setLocationRelativeTo(this);
                datos_areas_empresa.setVisible(true);
                limpiatabla();
                datos_areas_empresa=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(areas_empresa.class);
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(356, 48));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_areas_empresa = new datos_areas_empresa(null,true,conn,"",valor_privilegio);
        datos_areas_empresa.setLocationRelativeTo(this);
        datos_areas_empresa.setVisible(true);
        limpiatabla();
        datos_areas_empresa=null;
    ...
    */
    ...
    private JDialog datos_areas_empresa;
}
