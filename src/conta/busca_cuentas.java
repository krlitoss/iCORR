 ...
 * @author ANGEL
 */
public class busca_cuentas extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_cuentas(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_cuentas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Numero Cuenta", "Banco", "Saldo", "Moneda"
            }
        ) {
