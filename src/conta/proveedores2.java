...
public class proveedores2 extends javax.swing.JInternalFrame {
    ...
    public proveedores2(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Proveedores2");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM proveedores2 ORDER BY id_proveedor";
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_proveedores2 = new datos_proveedores2(null,true,conn,clavemodifica,valor_privilegio);
                datos_proveedores2.setLocationRelativeTo(this);
                datos_proveedores2.setVisible(true);
                limpiatabla();
                datos_proveedores2=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(proveedores2.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_proveedores2 = new datos_proveedores2(null,true,conn,"",valor_privilegio);
        datos_proveedores2.setLocationRelativeTo(this);
        datos_proveedores2.setVisible(true);
        limpiatabla();
        datos_proveedores2=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes2/proveedores2.jasper"));
             }
    ...
    */
    ...
    private JDialog datos_proveedores2;
}
