 ...
 * @author IVONNE
 */
public class datos_conceptos extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    String valor_privilegio="1";

    /** Creates new form datos_usuarios */
    public datos_conceptos(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT * FROM movconceptos WHERE id_movconcepto='"+clavemodifica+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    id.setText(rs0.getString("id_movconcepto"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_conceptos.class);
        ...
        tipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Abono", "Cargo" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(descripcion, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(descripcion.getText().equals("")){
            ...
            String senSQL="UPDATE movconceptos set descripcion='"+descripcion.getText()+"',tipo='"+(String)tipo.getSelectedItem()+"' WHERE id_movconcepto='"+id.getText()+"'";
            if(id.getText().equals("")){
                senSQL="INSERT INTO movconceptos (descripcion,tipo) VALUES('"+descripcion.getText()+"','"+(String)tipo.getSelectedItem()+"');";
            }
