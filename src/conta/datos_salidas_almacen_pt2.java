 ...
 * @author IVONNE
 */
public class datos_salidas_almacen_pt2 extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_salidas_almacen_pt2(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_salidas_almacen_pt2.class);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(clavearticulo, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
                            .addComponent(articulo, javax.swing.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
        ...
        setBounds((screenSize.width-458)/2, (screenSize.height-280)/2, 458, 280);
    }// </editor-fold>//GEN-END:initComponents

    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        // TODO add your handling code here:
        op.setText(op.getText().toUpperCase());
        if(fecha.getDate()==null||op.getText().equals("")||clavearticulo.getText().equals("")||cantidad.getText().equals("")||cantidad.getText().equals("0")||motivo.getText().equals("")){
            ...
            //revisa que exista cantidad en el inventario
            ...
            if(errorinventario==1||errorinventario==2){
                ...
                if (JOptionPane.showConfirmDialog(this,"ESTA SEGURO QUE DESEA GUARDAR!!"," I N F O R M A C I O N !!!!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                    ...
                    rs0=null;
                    try{
                        String senSQL="SELECT almacen_pt.*,articulos.kg,articulos.m2 FROM almacen_pt LEFT JOIN articulos ON almacen_pt.clavearticulo=articulos.clavearticulo  WHERE (almacen_pt.op='"+op.getText()+"' AND almacen_pt.clavearticulo='"+clavearticulo.getText()+"')";
                        rs0=conexion.consulta(senSQL,connj);
                        if(rs0.next()){
                            int cantidadinventario=rs0.getInt("cantidadpzas");
                            if(cantidadremisionar<=cantidadinventario){
                                //iserta una partida en salida de almacen PT
                                senSQL="INSERT INTO salidas_almacen_pt( estatus, fecha, remision, op, clavearticulo, cantidadpzas, pzaspaquete, almacen,notas) VALUES ('Act', '"+fechainsertarhora.format(new Date())+"', '-', '"+op.getText()+"', '"+clavearticulo.getText()+"', '"+cantidadremisionar+"', '"+rs0.getInt("pzaspaquete")+"', '"+rs0.getString("almacen")+"','"+motivo.getText()+" <-> Salida manual del inventario de PT por el usuario: "+conf.getProperty("UserID")+"');";
                                conexion.modificamov_p(senSQL,connj,valor_privilegio);
                                //actualiza el almacen de PT
                                senSQL = "UPDATE almacen_pt SET cantidadpzas='"+(cantidadinventario-cantidadremisionar)+"' WHERE (op='"+op.getText()+"' AND clavearticulo='"+clavearticulo.getText()+"');";
                                conexion.modificamov_p(senSQL, connj,valor_privilegio);
                            }
                        }
                        if(rs0!=null) {    rs0.close();  }
