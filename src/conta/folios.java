...
public class folios extends javax.swing.JInternalFrame {
    ...
    public folios(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Folios");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM folios WHERE estatus<>'Can' ORDER BY id_folio";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                int folioinicial=rs0.getInt("folioinicial");
                int foliofinal=rs0.getInt("foliofinal");
                int folioactual=rs0.getInt("folioactual");
                int disponibles=(foliofinal-folioinicial)-(folioactual-folioinicial);
                Object datos[]={rs0.getString("id_folio"),fechamascorta.format(rs0.getDate("fecha")),rs0.getString("aprobacion"),rs0.getString("anoaprobacion"),rs0.getString("serie"),folioinicial,foliofinal,folioactual,disponibles};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_folios = new datos_folios(null,true,conn,clavemodifica,valor_privilegio);
                datos_folios.setLocationRelativeTo(this);
                datos_folios.setVisible(true);
                limpiatabla();
                datos_folios=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(folios.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Aprobación", "Año aprobación", "Serie", "Folio Inicial", "Folio Final", "Folio Actual", "Disponibles"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_folios = new datos_folios(null,true,conn,"",valor_privilegio);
        datos_folios.setLocationRelativeTo(this);
        datos_folios.setVisible(true);
        limpiatabla();
        datos_folios=null;
