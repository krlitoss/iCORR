 ...
 * @author ANGEL
 */
public class busca_operador extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_operador(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM operadores ORDER BY nombre";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_operador"),rs0.getString("nombre")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_operador.class);
