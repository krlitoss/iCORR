...
public class agentes extends javax.swing.JInternalFrame {
    ...
    public agentes(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Vendedores");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM agentes ORDER BY id_agente";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_agente"),rs0.getString("nombre"),rs0.getDouble("comision"),rs0.getString("email"),rs0.getString("telefono")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_vendedor = new datos_agentes(null,true,conn,clavemodifica,valor_privilegio);
                datos_vendedor.setLocationRelativeTo(this);
                datos_vendedor.setVisible(true);
                limpiatabla();
                datos_vendedor=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(agentes.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre Agente", "% Comisión", "Correo", "Telefono"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_vendedor = new datos_agentes(null,true,conn,"",valor_privilegio);
        datos_vendedor.setLocationRelativeTo(this);
        datos_vendedor.setVisible(true);
        limpiatabla();
        datos_vendedor=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/agentes.jasper"));
             }
    ...
    */
    ...
    private JDialog datos_vendedor;
}
