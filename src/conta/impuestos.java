...
public class impuestos extends javax.swing.JInternalFrame {
    ...
    ResultSet rs0;
    DecimalFormat porcentaje2decimales=new DecimalFormat("% ##0.00");
    String valor_privilegio="1";

    /** Creates new form usuarios */
    public impuestos(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Esquema de Impuestos");
    }
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_impuestos"),rs0.getString("esquema"),rs0.getDouble("iva"),rs0.getDouble("ieps"),rs0.getDouble("ivaretenido"),rs0.getDouble("isrretenido"),rs0.getString("defaul")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_impuestos = new datos_impuestos(null,true,conn,clavemodifica,valor_privilegio);
                datos_impuestos.setLocationRelativeTo(this);
                datos_impuestos.setVisible(true);
                limpiatabla();
                datos_impuestos=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(impuestos.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Esquema", "% IVA", "% IEPS", "% Ret. IVA", "% Ret. ISR", "Default"
            }
        ) {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(456, 48));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_impuestos = new datos_impuestos(null,true,conn,"",valor_privilegio);
        datos_impuestos.setLocationRelativeTo(this);
        datos_impuestos.setVisible(true);
        limpiatabla();
        datos_impuestos=null;
    ...
    */
    ...
    private JDialog datos_impuestos;
}
