...
public class contactos extends javax.swing.JInternalFrame {
    ...
    public contactos(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Agenda de contactos");
    }
    public void ajusteTabladatos() {
        ...
        Tabladatos.getColumnModel().getColumn(5).setPreferredWidth(110);
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM contactos ORDER BY id_contacto";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_contacto"),rs0.getString("nombre"),rs0.getString("empresa"),rs0.getString("telefono1"),rs0.getString("telefono2"),rs0.getString("celular"),rs0.getString("nextel"),rs0.getString("correo1")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_contactos = new datos_contactos(null,true,conn,clavemodifica,valor_privilegio);
                datos_contactos.setLocationRelativeTo(this);
                datos_contactos.setVisible(true);
                limpiatabla();
                datos_contactos=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(contactos.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Empresa", "Telefono 1", "Telefono 2", "Celular", "Nextel", "Correo"
            }
        ) {
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        // TODO add your handling code here:
        datos_contactos = new datos_contactos(null,true,conn,"",valor_privilegio);
        datos_contactos.setLocationRelativeTo(this);
        datos_contactos.setVisible(true);
        limpiatabla();
        datos_contactos=null;
    ...
    private void btnimprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnimprimirActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/agenda.jasper"));
             }
    ...
    */
    ...
    private JDialog datos_contactos;
}
