 ...
 * @author IVONNE
 */
public class suajes extends javax.swing.JInternalFrame {
    ...
    public suajes(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Suajes");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT suajes.*,articulos.articulo,clientes.nombre FROM suajes LEFT JOIN (articulos LEFT JOIN clientes ON articulos.id_clientes=clientes.id_clientes) ON suajes.clavearticulo=articulos.clavearticulo ORDER BY suajes.fecha,suajes.clave_suaje,suajes.clavearticulo";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("clave_suaje"),rs0.getString("nombre"),rs0.getString("clavearticulo"),rs0.getString("articulo"),rs0.getString("tipo"),rs0.getDate("fecha"),rs0.getString("obsoleto"),rs0.getDate("fechaobsoleto")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_suajes = new datos_suajes(null,true,conn,clavemodifica,valor_privilegio);
                datos_suajes.setLocationRelativeTo(this);
                datos_suajes.setVisible(true);
                limpiatabla();
                datos_suajes=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(suajes.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Cliente", "Clave Articulo", "Articulo", "Tipo", "Fecha Fab.", "Obsoleto", "Fecha Obs."
            }
        ) {
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        // TODO add your handling code here:
        datos_suajes = new datos_suajes(null,true,conn,"",valor_privilegio);
        datos_suajes.setLocationRelativeTo(this);
        datos_suajes.setVisible(true);
        limpiatabla();
        datos_suajes=null;
    ...
    private void btnexportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnexportarActionPerformed
        // TODO add your handling code here:
        File rutaarchivo=new File(System.getProperty("user.home")+"/suajes.xls");
        try
        {
