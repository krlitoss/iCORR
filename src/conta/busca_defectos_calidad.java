 ...
 * @author ANGEL
 */
public class busca_defectos_calidad extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_defectos_calidad(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void ajusteTabladatos() {
        Tabladatos.getColumnModel().getColumn(0).setPreferredWidth(65);
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM defectos_calidad ORDER BY id_defecto_calidad";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_defectos_calidad.class);
    ...
    private void TabladatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabladatosMouseClicked
        // TODO add your handling code here:
            ...
            clavebusca=""+Tabladatos.getValueAt(filano, 0);
            salir();
