 ...
 * @author IVONNE
 */
public class gpoproductos extends javax.swing.JInternalFrame {
    ...
    public gpoproductos(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Grupo de Productos");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM gpoproductos ORDER BY id_gpoproducto";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_gpoproducto"),rs0.getString("clave"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_gpoproductos = new datos_gpoproductos(null,true,conn,clavemodifica,valor_privilegio);
                datos_gpoproductos.setLocationRelativeTo(this);
                datos_gpoproductos.setVisible(true);
                limpiatabla();
                datos_gpoproductos=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(gpoproductos.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_gpoproductos = new datos_gpoproductos(null,true,conn,"",valor_privilegio);
        datos_gpoproductos.setLocationRelativeTo(this);
        datos_gpoproductos.setVisible(true);
        limpiatabla();
        datos_gpoproductos=null;
    ...
    */
    ...
    private JDialog datos_gpoproductos;
}
