...
public class restaurar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(restaurar.class);
       ...
       if(servidor.getText().equals("") || puerto.getText().equals("") || bd.getText().equals("") || usuario.getText().equals("") || contra.equals(""))
        {
            ...
            try{
                ...
                {
                    //Process child = Runtime.getRuntime().exec(ruta.getText()+"\\pg_restore.exe --host "+servidor.getText()+" --port "+puerto.getText()+" --username "+usuario.getText()+" --dbname "+bd.getText()+ " --verbose  "+rutaBackup+"");
                    JOptionPane.showMessageDialog(this, "RESPALDO INSTALADO CORRECTAMENTE", " L I S T O !!!!!!!!!!",JOptionPane.INFORMATION_MESSAGE);
                    salir();
                }else{
                    JOptionPane.showMessageDialog(this, "DEBES SELECCIONAR UN ARCHIVO" , "E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
                }
            }catch(Exception e)   {   JOptionPane.showMessageDialog(this, "ERROR AL GENERAR ARCHIVO", "E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);         }
