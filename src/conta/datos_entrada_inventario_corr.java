 ...
 * @author IVONNE
 */
public class datos_entrada_inventario_corr extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_entrada_inventario_corr(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT entradas_inventario_corr.*,articulos.articulo FROM entradas_inventario_corr LEFT JOIN articulos ON entradas_inventario_corr.clavearticulo=articulos.clavearticulo WHERE entradas_inventario_corr.id_entradas_inventario_corr='"+clavemodifica+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    id.setText(rs0.getString("id_entradas_inventario_corr"));
                    ...
                    cantidad.setText(estandarentero.format(rs0.getInt("cantidadlaminas")));
                    notas.setText(rs0.getString("comentarios"));
                }
                if(rs0!=null) {
                    rs0.close();
                }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_entrada_inventario_corr.class);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(cantidad, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(fecha.getDate()==null||op.getText().equals("")||clavearticulo.getText().equals("")||cantidad.getText().equals("")||cantidad.getText().equals("0")||notas.getText().equals("")){
            ...
            if (JOptionPane.showConfirmDialog(this,"ESTA SEGURO QUE DESEA GUARDAR!!"," I N F O R M A C I O N !!!!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                String senSQL="INSERT INTO entradas_inventario_corr(estatus, fecha, turno, id_programa_corr_captura, id_programa_corr, op, clavearticulo, cantidadlaminas, almacen, ubicacion, comentarios, sistema) VALUES ('Act', '"+fechainsertarhora.format(fecha.getDate())+"', '"+(String)turno.getSelectedItem()+"', '0', '0', '"+op.getText()+"', '"+clavearticulo.getText()+"', '"+cantidad.getText()+"', '2', '', '"+notas.getText()+"', false);";
