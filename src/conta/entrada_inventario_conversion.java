 ...
 * @author IVONNE
 */
public class entrada_inventario_conversion extends javax.swing.JInternalFrame {
    ...
    public entrada_inventario_conversion(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Entradas Inventario Conversion");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT conversion_captura.*,articulos.articulo,articulos.piezas,articulos.kg,articulos.preciomillar,clientes.nombre FROM conversion_captura LEFT JOIN (articulos LEFT JOIN clientes ON articulos.id_clientes=clientes.id_clientes) ON conversion_captura.clavearticulo=articulos.clavearticulo WHERE (conversion_captura.estatus<>'Can' AND conversion_captura.sistema='false' AND conversion_captura.clave<>'CORR' AND conversion_captura.maquina_inventario isnull AND (conversion_captura.fechareal>='"+conf.getProperty("FechaIni")+" 00:00:00' AND conversion_captura.fechareal<='"+conf.getProperty("FechaFin")+" 23:59:59')) ORDER BY conversion_captura.fechareal;";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                int cantidad=rs0.getInt("cantidadpiezas");
                int kg=(int) (cantidad * rs0.getDouble("kg"));
                Object datos[]={rs0.getString("id_conversion_captura"),rs0.getDate("fechareal"),rs0.getString("turno"),rs0.getString("clave"),rs0.getString("op"),rs0.getString("nombre"),rs0.getString("clavearticulo"),rs0.getString("articulo"),cantidad,kg};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_entrada_inventario_conversion = new datos_entrada_inventario_conversion(null,true,conn,clavemodifica,valor_privilegio);
                datos_entrada_inventario_conversion.setLocationRelativeTo(this);
                datos_entrada_inventario_conversion.setVisible(true);
                limpiatabla();
                datos_entrada_inventario_conversion=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(entrada_inventario_conversion.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Turno", "Maquina", "OP", "Cliente", "Clave Articulo", "Articulo", "Piezas", "KG"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.util.Date.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class
            };
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        // TODO add your handling code here:
        datos_entrada_inventario_conversion = new datos_entrada_inventario_conversion(null,true,conn,"",valor_privilegio);
        datos_entrada_inventario_conversion.setLocationRelativeTo(this);
        datos_entrada_inventario_conversion.setVisible(true);
        limpiatabla();
        datos_entrada_inventario_conversion=null;
    ...
    private void btnconActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconActionPerformed
        ...
        if (estado.equals("cancelar")) {
            ...
            rs0=null;
            try{
                String senSQL="SELECT conversion_captura.*,articulos.articulo,articulos.piezas,articulos.kg,articulos.preciomillar,clientes.nombre FROM conversion_captura LEFT JOIN (articulos LEFT JOIN clientes ON articulos.id_clientes=clientes.id_clientes) ON conversion_captura.clavearticulo=articulos.clavearticulo WHERE (conversion_captura.estatus<>'Can' AND conversion_captura.sistema='false' AND conversion_captura.clave<>'CORR' AND conversion_captura.maquina_inventario isnull AND (conversion_captura.fechareal>='"+fechainsertar.format(busca_fechas.getFechaini())+" 00:00:00' AND conversion_captura.fechareal<='"+fechainsertar.format(busca_fechas.getFechafin())+" 23:59:59')) ORDER BY conversion_captura.fechareal;";
                rs0=conexion.consulta(senSQL,conn);
                while(rs0.next()){
                    int cantidad=rs0.getInt("cantidadpiezas");
                    int kg=(int) (cantidad * rs0.getDouble("kg"));
    ...
    */
    ...
    private JDialog datos_entrada_inventario_conversion;
}
