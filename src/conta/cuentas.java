...
public class cuentas extends javax.swing.JInternalFrame {
    ...
    public cuentas(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Cuentas Bancarias");
    }
    public void ajusteTabladatos() {
        ...
        Tabladatos.getColumnModel().getColumn(2).setPreferredWidth(160);
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT cuentasbancarias.id_cuenta,cuentasbancarias.fecha,cuentasbancarias.tipocuenta,cuentasbancarias.numerocuenta,cuentasbancarias.id_moneda,cuentasbancarias.saldoinicial,cuentasbancarias.nombrebanco,cuentasbancarias.sucursal,(cuentasbancarias.saldoinicial+cuentasbancarias.totalabonos-cuentasbancarias.totalcargos) as saldofinal,monedas.id_moneda,monedas.descripcion FROM cuentasbancarias LEFT JOIN monedas ON monedas.id_moneda = cuentasbancarias.id_moneda ORDER BY cuentasbancarias.id_cuenta ASC;";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_cuenta"),rs0.getString("numerocuenta"),rs0.getString("nombrebanco"),rs0.getString("tipocuenta"),rs0.getString("descripcion"),rs0.getDouble("saldofinal")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_cuentas = new datos_cuentas(null,true,conn,clavemodifica,valor_privilegio);
                datos_cuentas.setLocationRelativeTo(this);
                datos_cuentas.setVisible(true);
                limpiatabla();
                datos_cuentas=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(cuentas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Numero de Cuenta", "Banco", "Tipo", "Moneda", "Saldo"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_cuentas = new datos_cuentas(null,true,conn,"",valor_privilegio);
        datos_cuentas.setLocationRelativeTo(this);
        datos_cuentas.setVisible(true);
        limpiatabla();
        datos_cuentas=null;
