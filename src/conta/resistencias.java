 ...
 * @author IVONNE
 */
public class resistencias extends javax.swing.JInternalFrame {
    ...
    public resistencias(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Resistencias");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM resistencias ORDER BY id_resistencia";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_resistencia"),rs0.getString("clave"),rs0.getString("descripcion"),rs0.getString("corrugado"),rs0.getString("color"),rs0.getDouble("pesom2"),rs0.getDouble("pesom2real"),rs0.getString("tipo"),rs0.getDouble("valorminimo")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_resistencias = new datos_resistencias(null,true,conn,clavemodifica,valor_privilegio);
                datos_resistencias.setLocationRelativeTo(this);
                datos_resistencias.setVisible(true);
                limpiatabla();
                datos_resistencias=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(resistencias.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Clave", "Descripcion", "Corrugado", "Color", "Peso M2", "Peso M2 real", "Tipo", "Valor Minimo"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class, java.lang.Double.class
            };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_resistencias = new datos_resistencias(null,true,conn,"",valor_privilegio);
        datos_resistencias.setLocationRelativeTo(this);
        datos_resistencias.setVisible(true);
        limpiatabla();
        datos_resistencias=null;
    ...
    */
    ...
    private JDialog datos_resistencias;
}
