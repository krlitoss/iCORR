...
public class productos extends javax.swing.JInternalFrame {
    ...
    public productos(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Productos");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT productos.*, proveedores.nombre,gpoproductos.descripcion as categoria FROM (productos LEFT JOIN proveedores ON proveedores.id_proveedor = productos.id_proveedor1) LEFT JOIN gpoproductos ON gpoproductos.id_gpoproducto=productos.id_gpoproducto ORDER BY id_producto";
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_productos = new datos_productos(null,true,conn,clavemodifica,valor_privilegio);
                datos_productos.setLocationRelativeTo(this);
                datos_productos.setVisible(true);
                limpiatabla();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(productos.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Long.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class
            };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_productos = new datos_productos(null,true,conn,"",valor_privilegio);
        datos_productos.setLocationRelativeTo(this);
        datos_productos.setVisible(true);
        limpiatabla();
        datos_productos=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/productos.jasper"));
             }
    ...
    */
    ...
    private JDialog datos_productos;
}
