 ...
 * @author ANGEL
 */
public class busca_productos extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_productos(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String clavepro,String categoria) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(String cat,String claveprov){

        String sqldin="";
        if(!claveprov.equals(""))
            sqldin="AND (productos.id_proveedor1='"+claveprov+"' OR productos.id_proveedor2='"+claveprov+"')";
        
        rs0=null;
        try{/*WHERE (productos.id_gpoproducto='"+cat+"' "+sqldin+") ORDER BY productos.id_producto -- SE ELIMINO ESTA CENTENCIA PARA PODER CONSULTAR LOS PRODUCTOS*/
            String senSQL="SELECT productos.*, proveedores.nombre,gpoproductos.descripcion as categoria FROM (productos LEFT JOIN proveedores ON proveedores.id_proveedor = productos.id_proveedor1) LEFT JOIN gpoproductos ON gpoproductos.id_gpoproducto=productos.id_gpoproducto ";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_producto"),rs0.getString("clave"),rs0.getString("descripcion"),rs0.getString("categoria"),rs0.getDouble("preciocompra"),rs0.getDouble("existencias"),rs0.getDouble("stockmax"),rs0.getDouble("stockmin"),rs0.getString("nombre")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_productos.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Clave", "Descripcion", "Categoria", "Precio Compra", "Existencias", "SMax", "SMin", "Proveedor"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class, java.lang.String.class
            };
