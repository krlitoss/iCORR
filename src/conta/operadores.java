 ...
 * @author IVONNE
 */
public class operadores extends javax.swing.JInternalFrame {
    ...
    public operadores(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Operadores");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT operadores.*,maquinas.descripcion FROM operadores LEFT JOIN maquinas ON operadores.clavemaquina=maquinas.clave WHERE operadores.activo='Si' ORDER BY id_operador";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_operador"),rs0.getString("nombre"),rs0.getString("clavemaquina"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_operadores = new datos_operadores(null,true,conn,clavemodifica,valor_privilegio);
                datos_operadores.setLocationRelativeTo(this);
                datos_operadores.setVisible(true);
                limpiatabla();
                datos_operadores=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(operadores.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_operadores = new datos_operadores(null,true,conn,"",valor_privilegio);
        datos_operadores.setLocationRelativeTo(this);
        datos_operadores.setVisible(true);
        limpiatabla();
        datos_operadores=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/operadores.jasper"));
    ...
    */
    ...
    private JDialog datos_operadores;
}
