 ...
 * @author IVONNE
 */
public class datos_entrada_inventario_conversion extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_entrada_inventario_conversion(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_entrada_inventario_conversion.class);
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(fecha.getDate()==null||op.getText().equals("")||clavearticulo.getText().equals("")||cantidad.getText().equals("")||cantidad.getText().equals("0")||notas.getText().equals("")||errormaquina==1){
            ...
            if (JOptionPane.showConfirmDialog(this,"ESTA SEGURO QUE DESEA GUARDAR!!"," I N F O R M A C I O N !!!!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                String senSQL="INSERT INTO conversion_captura(estatus, fechareal, turno, op, clavearticulo,clave, cantidadpiezas,notas) VALUES ('Act', '"+fechainsertarhora.format(fecha.getDate())+"', '"+(String)turno.getSelectedItem()+"','"+op.getText()+"', '"+clavearticulo.getText()+"','"+clavemaquina.getSelectedItem()+"','"+cantidad.getText()+"','"+notas.getText()+"');";
