 ...
 * @author ANGEL
 */
public class busca_monedas extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_monedas(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_moneda"),rs0.getString("descripcion"),rs0.getDouble("valor")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_monedas.class);
