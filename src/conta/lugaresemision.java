 ...
 * @author IVONNE
 */
public class lugaresemision extends javax.swing.JInternalFrame {
    ...
    public lugaresemision(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Lugares Emisión");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM lugaresemision ORDER BY id_lugaremision";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_lugaremision"),rs0.getString("calle"),rs0.getString("colonia"),rs0.getString("municipio"),rs0.getString("estado"),rs0.getString("pais")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_lugaresemision = new datos_lugaresemision(null,true,conn,clavemodifica,valor_privilegio);
                datos_lugaresemision.setLocationRelativeTo(this);
                datos_lugaresemision.setVisible(true);
                limpiatabla();
                datos_lugaresemision=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(lugaresemision.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Calle", "Colonia", "Municipio", "Estado", "Pais"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_lugaresemision = new datos_lugaresemision(null,true,conn,"",valor_privilegio);
        datos_lugaresemision.setLocationRelativeTo(this);
        datos_lugaresemision.setVisible(true);
        limpiatabla();
        datos_lugaresemision=null;
    ...
    */
    ...
    private JDialog datos_lugaresemision;
}
