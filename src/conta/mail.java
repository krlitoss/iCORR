...
public class mail extends javax.swing.JInternalFrame {
        ...
        modelot1.addTableModelListener(new TableModelListener() {
          public void tableChanged(TableModelEvent te) {
                try{
                    ...
                    if (c == 3) {
                        String val=""+model.getValueAt(f, c);
                        String pc=""+model.getValueAt(f, 0);
                        if(!pc.equals("null")){
                            if(val.equals("true")){
                                String senSQLmov="UPDATE correo SET uso='false';";
                                conexion.modificamov_p(senSQLmov,conn,valor_privilegio);
                                senSQLmov="UPDATE correo SET uso='"+val+"' WHERE id_correo='"+pc+"';";
                                conexion.modificamov_p(senSQLmov,conn,valor_privilegio);
                            }
                            limpiatabla();
                            datos();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"SMTP Mail");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM correo ORDER BY id_correo";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_correo"),rs0.getString("host"),rs0.getString("usuario"),rs0.getBoolean("uso")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_mail = new datos_mail(null,true,conn,clavemodifica,valor_privilegio);
                datos_mail.setLocationRelativeTo(this);
                datos_mail.setVisible(true);
                limpiatabla();
                datos_mail=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(mail.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_mail = new datos_mail(null,true,conn,"",valor_privilegio);
        datos_mail.setLocationRelativeTo(this);
        datos_mail.setVisible(true);
        limpiatabla();
        datos_mail=null;
