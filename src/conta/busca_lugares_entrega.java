 ...
 * @author ANGEL
 */
public class busca_lugares_entrega extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_lugares_entrega(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String clavecli) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT lugares_entregas.*,clientes.nombre FROM lugares_entregas LEFT JOIN clientes ON lugares_entregas.id_clientes=clientes.id_clientes WHERE lugares_entregas.id_clientes='"+clavecliente+"'  ORDER BY id_lugarentrega";
            rs0=conexion.consulta(senSQL,connj);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_lugarentrega"),rs0.getString("nombre"),rs0.getString("calle")+" "+rs0.getString("numeroext")+" Col. "+rs0.getString("colonia"),rs0.getString("municipio"),rs0.getString("estado")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_lugares_entrega.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Nombre del Cliente", "Dirección", "Municipio", "Estado", "Title 6"
            }
        ) {
