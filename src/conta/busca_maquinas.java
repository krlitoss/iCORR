 ...
 * @author ANGEL
 */
public class busca_maquinas extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_maquinas(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("clave"),rs0.getString("descripcion"),rs0.getInt("arreglo"),rs0.getInt("velocidad")};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_maquinas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Descripción", "Arreglo (min)", "Velocidad"
            }
        ) {
