 ...
 * @author IVONNE
 */
public class paros extends javax.swing.JInternalFrame {
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Claves de Paro");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT paros.*,maquinas.descripcion as desmaq FROM paros LEFT JOIN maquinas ON paros.clavemaquina=maquinas.clave WHERE paros.activo='Si' ORDER BY id_paro";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_paro"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_paros = new datos_paros(null,true,conn,clavemodifica,valor_privilegio);
                datos_paros.setLocationRelativeTo(this);
                datos_paros.setVisible(true);
                limpiatabla();
                datos_paros=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(paros.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_paros = new datos_paros(null,true,conn,"",valor_privilegio);
        datos_paros.setLocationRelativeTo(this);
        datos_paros.setVisible(true);
        limpiatabla();
        datos_paros=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/paros.jasper"));
