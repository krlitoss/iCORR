 ...
 * @author IVONNE
 */
public class datos_defectos_calidad extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public datos_defectos_calidad(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String valor_privilegio_t) {
        super(parent, modal);
        initComponents();
        connj=conn;
    ...
    public void consultamodifica(String clavemodifica){
        if(clavemodifica.equals("")){
            ...
            rs0=null;
            try{
                String senSQL="SELECT * FROM defectos_calidad WHERE id_defecto_calidad='"+clavemodifica+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    id.setText(rs0.getString("id_defecto_calidad"));
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(datos_defectos_calidad.class);
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if(id.getText().equals("") || descripcion.getText().equals("")){
            ...
            String senSQL="UPDATE defectos_calidad set descripcion='"+descripcion.getText()+"' WHERE id_defecto_calidad='"+id.getText()+"'";
            if(clavemodificaf.equals("")){
                senSQL="INSERT INTO defectos_calidad(id_defecto_calidad, descripcion, activo) VALUES ('"+id.getText()+"', '"+descripcion.getText()+"', 'Si');";
            }
    ...
    private void idFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_idFocusLost
        ...
        if(id.getText().equals("")){
            ...
            try{
                ...
                String senSQL="SELECT * FROM defectos_calidad WHERE id_defecto_calidad='"+id.getText()+"'";
                rs0=conexion.consulta(senSQL,connj);
                if(rs0.next()){
                    JOptionPane.showMessageDialog(this,"LA CLAVE DE DEFECTO YA EXISTE","E R R O R !!!!!!!!!!",JOptionPane.ERROR_MESSAGE);
                    id.setText("");
                    id.requestFocus();
                }
                if(rs0!=null) {
