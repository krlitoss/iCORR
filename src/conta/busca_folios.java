 ...
 * @author ANGEL
 */
public class busca_folios extends javax.swing.JDialog {
    Connection connj;
    ResultSet rs0=null;
    ...
    public busca_folios(java.awt.Frame parent, boolean modal,Connection conn,String clavemodifica,String tipofolio) {
        super(parent, modal);
        initComponents();
    ...
    public void datos(String tipofolio){
        if(!tipofolio.equals(""))
            tipofolio=" AND serie='"+tipofolio+"'";

        rs0=null;
        try{
            String senSQL="SELECT * FROM folios WHERE (estatus<>'Can'"+tipofolio+") ORDER BY id_folio";
            ...
            while(rs0.next()){
                ...
                if(disponibles>0){
                    Object datos[]={rs0.getString("id_folio"),fechamascorta.format(rs0.getDate("fecha")),rs0.getString("aprobacion"),rs0.getString("anoaprobacion"),rs0.getString("serie"),folioinicial,foliofinal,folioactual};
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(busca_folios.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Fecha", "Aprobación", "Año Aprobación", "Serie", "Folio Inicial", "Folio Final", "Folio Actual"
            }
        ) {
