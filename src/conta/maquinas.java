...
public class maquinas extends javax.swing.JInternalFrame {
    ...
    public maquinas(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Máquinas");
    }
    ...
    public void datos(){
        ...
        try{
            ...
            while(rs0.next()){
                Object datos[]={rs0.getString("id_maquina"),rs0.getString("clave"),rs0.getString("descripcion"),rs0.getInt("capacidad"),rs0.getDouble("costokg"),rs0.getInt("arreglo"),rs0.getInt("velocidad"),rs0.getString("unidadvelocidad")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_maquinas = new datos_maquinas(null,true,conn,clavemodifica,valor_privilegio);
                datos_maquinas.setLocationRelativeTo(this);
                datos_maquinas.setVisible(true);
                limpiatabla();
                datos_maquinas=null;
                datos();
            }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(maquinas.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Clave", "Descripcion", "Capacidad 1T", "Costo Kg", "Arreglo (min)", "Velocidad (min)", "UM"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class
            };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_maquinas = new datos_maquinas(null,true,conn,"",valor_privilegio);
        datos_maquinas.setLocationRelativeTo(this);
        datos_maquinas.setVisible(true);
        limpiatabla();
        datos_maquinas=null;
    ...
    */
    ...
    private JDialog datos_maquinas;
}
