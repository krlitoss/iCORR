 ...
 * @author IVONNE
 */
public class defectos_calidad extends javax.swing.JInternalFrame {
    ...
    public defectos_calidad(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Defectos de Calidad");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM defectos_calidad WHERE activo='Si' ORDER BY id_defecto_calidad";
            rs0=conexion.consulta(senSQL,conn);
            while(rs0.next()){
                Object datos[]={rs0.getString("id_defecto_calidad"),rs0.getString("descripcion")};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_defectos_calidad = new datos_defectos_calidad(null,true,conn,clavemodifica,valor_privilegio);
                datos_defectos_calidad.setLocationRelativeTo(this);
                datos_defectos_calidad.setVisible(true);
                limpiatabla();
                datos_defectos_calidad=null;
                datos();
            }
        }
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(defectos_calidad.class);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_defectos_calidad = new datos_defectos_calidad(null,true,conn,"",valor_privilegio);
        datos_defectos_calidad.setLocationRelativeTo(this);
        datos_defectos_calidad.setVisible(true);
        limpiatabla();
        datos_defectos_calidad=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            try{
                masterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/reportes/defectos_calidad.jasper"));
    ...
    */
    ...
    private JDialog datos_defectos_calidad;
}
