...
public class clientes extends javax.swing.JInternalFrame {
    ...
    public clientes(Connection connt) {
        initComponents();
    ...
    public void datos_privilegios(){
        valor_privilegio=conexion.obtener_privilegios(conn,"Clientes");
    }
    ...
    public void datos(){
        rs0=null;
        try{
            String senSQL="SELECT * FROM clientes WHERE obsoleto = 'No' ORDER BY id_clientes";
            ...
            while(rs0.next()){
                ...
                Object datos[]={rs0.getString("id_clientes"),rs0.getString("nombre"),rs0.getString("rfc"),rs0.getInt("dias"),rs0.getString("contacto"),rs0.getString("telefono1"),rs0.getString("email"),b};
    ...
    public void modificar(){
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                datos_clientes = new datos_clientes(null,true,conn,clavemodifica,valor_privilegio);
                datos_clientes.setLocationRelativeTo(this);
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(conta.CONTAApp.class).getContext().getResourceMap(clientes.class);
        ...
        Tabladatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Nombre del Cliente", "RFC", "Dias de Crédito", "Contacto", "Telefono", "Correo", "Bloq."
            }
        ) {
        ...
        jButton4.getAccessibleContext().setAccessibleParent(jToolBar1);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        datos_clientes = new datos_clientes(null,true,conn,"",valor_privilegio);
        datos_clientes.setLocationRelativeTo(this);
        datos_clientes.setVisible(true);
        limpiatabla();
        datos_clientes=null;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                String si=""+Tabladatos.getValueAt(filano, 7);
                if(si.equals("No")){
                    String motivoelimina=""+JOptionPane.showInputDialog(this, "INTRODUCE EL MOTIVO DE BLOQUEA", "P R E G U N T A !!!!!!!!!!", JOptionPane.QUESTION_MESSAGE);
                    if(!motivoelimina.equals("") && !motivoelimina.equals("null")){
                        String senSQLmov = "UPDATE clientes SET bloqueado='0',observaciones='Bloqueado: "+motivoelimina+"' WHERE id_clientes='" + clavemodifica + "';";
                        conexion.modificaupdate_p(senSQLmov, conn,valor_privilegio);
                        //agrega registro a la bitacora
                        try{
                            senSQLmov="INSERT INTO bitacora(usuario, fecha, descripcion,host) VALUES ('"+conf.getProperty("UserID")+"', '"+fechainsertarhora.format(new java.util.Date())+"', 'Bloqueo de cliente: "+clavemodifica+"','"+java.net.InetAddress.getLocalHost().getCanonicalHostName()+"');";
                            conexion.modificamov_p(senSQLmov,conn,valor_privilegio);
                        }catch(Exception e){}
                    }
                }else{
                    if(JOptionPane.showConfirmDialog(this,"ESTA SEGURO QUE DESEA DESBLOQUEAR!!"," I N F O R M A C I O N !!!!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        String senSQLmov = "UPDATE clientes SET bloqueado='1',observaciones='' WHERE id_clientes='" + clavemodifica + "';";
                        conexion.modificaupdate_p(senSQLmov, conn,valor_privilegio);
                        //agrega registro a la bitacora
                        try{
                            senSQLmov="INSERT INTO bitacora(usuario, fecha, descripcion,host) VALUES ('"+conf.getProperty("UserID")+"', '"+fechainsertarhora.format(new java.util.Date())+"', 'Desbloqueo de cliente: "+clavemodifica+"','"+java.net.InetAddress.getLocalHost().getCanonicalHostName()+"');";
                            conexion.modificamov_p(senSQLmov,conn,valor_privilegio);
                        }catch(Exception e){}
                    }
                }
...
/*BOTON DAR DE BAJA CLIENTE*/
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(filano<0){
            ...
            if(clavemodifica.equals("")){
                ...
                String si=""+Tabladatos.getValueAt(filano, 7);
                if(si.equals("No")){
                    String motivoelimina=""+JOptionPane.showInputDialog(this, "INTRODUCE EL MOTIVO DE LA BAJA DEL CLIENTE", "P R E G U N T A !!!!!!!!!!", JOptionPane.QUESTION_MESSAGE);
                    if(!motivoelimina.equals("") && !motivoelimina.equals("null")){
                        String senSQLmov = "UPDATE clientes SET obsoleto='Si',observaciones='Cancelado por: "+motivoelimina+"' WHERE id_clientes='" + clavemodifica + "';";
                        conexion.modificaupdate_p(senSQLmov, conn,valor_privilegio);
                        //agrega registro a la bitacora
                        try{
                            senSQLmov="INSERT INTO bitacora(usuario, fecha, descripcion,host) VALUES ('"+conf.getProperty("UserID")+"', '"+fechainsertarhora.format(new java.util.Date())+"', 'Baja de cliente: "+clavemodifica+"','"+java.net.InetAddress.getLocalHost().getCanonicalHostName()+"');";
                            conexion.modificamov_p(senSQLmov,conn,valor_privilegio);
                        }catch(Exception e){}
                    }
                }
    ...
    */
    ...
    private JDialog datos_clientes;
}
