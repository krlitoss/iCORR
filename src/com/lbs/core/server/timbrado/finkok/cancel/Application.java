...
public interface Application {
     ...
     * @param password
     * @return
     *     returns com.lbs.core.server.timbrado.finkok.cancel.QueryPendingResult
     */
    ...
    @RequestWrapper(localName = "query_pending_cancellation", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.QueryPendingCancellation")
    @ResponseWrapper(localName = "query_pending_cancellationResponse", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.QueryPendingCancellationResponse")
     ...
     * @param password
     * @return
     *     returns com.lbs.core.server.timbrado.finkok.cancel.CancelaCFDResult
     */
    ...
    @RequestWrapper(localName = "cancel_signature", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.CancelSignature")
    @ResponseWrapper(localName = "cancel_signatureResponse", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.CancelSignatureResponse")
    ...
    @RequestWrapper(localName = "cancel", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.Cancel")
    @ResponseWrapper(localName = "cancelResponse", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.CancelResponse")
     ...
     * @param password
     * @return
     *     returns com.lbs.core.server.timbrado.finkok.cancel.ReceiptResult
     */
    ...
    @RequestWrapper(localName = "get_receipt", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.GetReceipt")
    @ResponseWrapper(localName = "get_receiptResponse", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.GetReceiptResponse")
    ...
    @RequestWrapper(localName = "out_cancel", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.OutCancel")
    @ResponseWrapper(localName = "out_cancelResponse", targetNamespace = "http://facturacion.finkok.com/cancel", className = "com.lbs.core.server.timbrado.finkok.cancel.OutCancelResponse")
